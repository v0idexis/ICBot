...
name: ["promote"],
type: ['setting'],
description: "make a member an admin (only can be done when you become an admin)",
admin: true,
botAdmin:true,
...
if (m.message.extendedTextMessage === undefined || m.message.extendedTextMessage === null) return m.reply('Tag or m.reply user is already an admin!')
